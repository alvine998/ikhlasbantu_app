...
const Pembayaran = (props) => {
    ...
    const uploadImage = async () => {
        ...
        result = await fetch(`http://ikhlasbantu.herokuapp.com/upload/ktp`, {
            method: "POST",
            body: formData
        }).then(
            res => res.json().then(
        ...
        axios.put(`http://ikhlasbantu.herokuapp.com/transaksi/user/${idUser}`, foto ? dataUpdate : dataUpdate2).then(
            res => {
                    ...
                    <View style={styles.container}>
                        ...
                        <View style={styles.container}>
                            <TouchableOpacity onPress={() => selectImage()}>
                                ...
                                {/* {
                                    (photo !== '' || oldphoto !== '') && (
                                        <Image source={{uri: oldphoto !== photo ? photo : `http://ikhlasbantu.herokuapp.com/resources/uploads/${oldphoto}`}} style={styles.imgSize} />
                                    )
                                } */}
