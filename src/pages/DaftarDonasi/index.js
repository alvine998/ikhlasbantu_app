            ...
            res => {
                axios.get(`https://ikhlasbantu.herokuapp.com/users/mail/${res}`).then(
                    result => {
                        ...
                        axios.post(`https://ikhlasbantu.herokuapp.com/donasis/userid`, id).then(
                            resp => {
                                    ...
                                    <TouchableOpacity key={i} style={{ flexDirection: "row" }} onPress={() => sendDonasi(e._id, e.statusdonasi)}>
                                        {
                                            e.foto == '' ? (
                                                ...
                                                <Image source={{ uri: `https://ikhlasbantu.herokuapp.com/resources/uploads/${e.foto}` }} style={styles.imgSize2} />
                                            )
                                        }
