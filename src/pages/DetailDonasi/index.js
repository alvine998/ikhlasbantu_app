    ...
    const getDonasi = async () => {
        await AsyncStorage.getItem("donasiKey").then(
            res => {
                ...
                axios.get(`http://ikhlasbantu.herokuapp.com/transaksi/donasi/${res}`).then(
                    res => {
                        const id = res.data;
                        console.log(id);
                        setLen(id)
                ...
                axios.get(`http://ikhlasbantu.herokuapp.com/donasis/${res}`).then(
                    res => {
                ...
                <ScrollView>
                    <View style={styles.container}>
                        ...
                        >
                            <View style={{ justifyContent: "center", alignItems: "center" }}>
                                <View style={styles.boxModal}>
                                    <Image source={{ uri: `http://ikhlasbantu.herokuapp.com/resources/uploads/${foto}` }} style={styles.imgSize3} />
                        ...
                        <TouchableOpacity onPress={() => setModalVisible(true)}>
                            <Image source={{ uri: `http://ikhlasbantu.herokuapp.com/resources/uploads/${foto}` }} style={styles.imgSize2} />
                        </TouchableOpacity>
                    </View>
